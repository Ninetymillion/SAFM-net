...
from utils_jiazhuangxian import *
...
class setting_config:
    ...
    datasets = 'dataset'
    if datasets == 'BUSIDataset':
        data_path = '/home/u2308283048/winnie/MedSegDiff/BUSIDataset/'

    elif datasets == 'dataset':
        data_path = '/root/autodl-tmp/dataset'    #'''C:/Users/thor/Desktop/UltraLight-VM-UNet-main/ULTM/dataset/'''
    else:
    ...
    rank = None
    amp = False
    batch_size = 8  # 24->48 ddti:8 tn3k:32
    epochs = 200  # 这里训练的总论述

    work_dir = './jia_results/ddti/'+','+network+'_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
    ...
    if opt == 'Adadelta':
        ...
        lr = 0.01  # default: 1e-3 – learning rate
        ...
        lr = 0.0001  # default: 1e-3 – learning rate   ddti：0.0001
        betas = (0.9, 0.999)  # default: (0.9, 0.999) – coefficients used for computing running averages of gradient and its square
        eps = 1e-8  # default: 1e-8 – term added to the denominator to improve numerical stability
